...
class BrugesPlanner {
    ...
    formatItinerary(itinerary) {
        // Convert markdown to HTML and add custom styling
        const formattedContent = marked.parse(itinerary);
            ...
            <div class="itinerary-content">
                ...
                <div class="itinerary-tips">
                    ...
                    <ul>
                        ...
                        <li>Many attractions accept card payments, but carry some cash</li>
                        <li>Consider buying a Bruges City Card for museum access</li>
                        <li>Most museums are closed on Mondays</li>
                    </ul>
                </div>
            </div>
        `;
